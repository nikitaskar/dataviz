...
class Shard {
	constructor() {
		...
		for (var i = 0; i < shards; i++) {
			this.translation[this.translationIterator++] = Math.cos((i/shards)*Math.PI*2)*23+Math.random()*8-4
			this.translation[this.translationIterator++] = Math.sin((i/shards)*Math.PI*2)*13+Math.random()*8-4
			this.translation[this.translationIterator++] = 0
	        ...
	        this.scale[this.scaleIterator++] = Math.random()*0.3+0.1;
	        this.scale[this.scaleIterator++] = Math.random()*0.3+0.1;
	        this.scale[this.scaleIterator++] = Math.random()*0.3+0.1;
